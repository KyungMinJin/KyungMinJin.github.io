...
description: "Kyung-Min Jin is a researcher at LG Electronics advanced robotics lab, studying multimodal intelligence and Embodied AI after graduating from Korea University PRML Lab."
description_ko: "고려대학교 PRML 연구실 졸업 후 LG전자 선행 로봇 연구팀에서 멀티모달 지능 및 Embodied AI를 연구하고 있는 진경민입니다."
...
최근에는 로봇 선행 연구 조직에서 로봇 인지 및 자연어 기반 객체 이해 기술을 연구하고 있으며, 멀티모달 파운데이션 모델과 Embodied 인공지능을 연결해 로봇이 시각 정보를 언어적으로 이해하고 물리적 환경과 효과적으로 상호작용할 수 있도록 하는 것을 목표로 하고 있습니다.
