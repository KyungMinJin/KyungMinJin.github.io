...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="publication-item mb-4 pb-3 border-bottom">
            <span class="badge badge-secondary mb-2">Preprint</span>
            <span class="badge badge-info mb-2">Multimodal Learning</span>
            <h5 class="font-weight-bold text-dark">MAPLE: Modality-Aware Post-training and Learning Ecosystem</h5>
  ...
  primaryClass={cs.LG}
        ...
        <!-- Publication 2 -->
        <div class="publication-item mb-4 pb-3 border-bottom">
            <span class="badge badge-warning mb-2">Under Review</span>
            <span class="badge badge-info mb-2">Action Localization</span>
            <h5 class="font-weight-bold text-dark">Calibrated Attention Masking Network for Temporal Action Localization</h5>
            <p class="authors mb-1 text-muted">
                Tae-Kyung Kang, Gun-Hee Lee, Woo-Jeoung Nam, Hyun-Woo Kim, <strong>Kyung-Min Jin</strong>, and Seong-Whan Lee
            </p>
            <p class="venue mb-2">
  ...
  doi={10.1016/j.patcog.2023.109908}
        ...
        <div class="publication-item mb-4 pb-3 border-bottom">
            <span class="badge badge-secondary mb-2">Preprint</span>
            <span class="badge badge-info mb-2">3D Hand Pose</span>
            <h5 class="font-weight-bold text-dark">Mesh Represented Recycle Learning for 3D Hand Pose and Mesh Estimation</h5>
            <p class="authors mb-1 text-muted">
  ...
  primaryClass={cs.CV}
        ...
        <div class="publication-item mb-4 pb-3 border-bottom">
            ...
            <span class="badge badge-info mb-2">Human Pose Estimation</span>
            <h5 class="font-weight-bold text-dark">Kinematic-aware Hierarchical Attention Network for Human Pose Estimation in Videos</h5>
            <p class="authors mb-1 text-muted">
  ...
  year={2023}
        ...
        <div class="publication-item mb-4 pb-3">
            <span class="badge badge-danger mb-2">SMC 2022 (Oral)</span>
            <span class="badge badge-info mb-2">Pose Estimation</span>
            <h5 class="font-weight-bold text-dark">OTPose: Occlusion-Aware Transformer for Pose Estimation in Sparsely-Labeled Videos</h5>
            <p class="authors mb-1 text-muted">
