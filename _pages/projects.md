...
<div class="row">
    <div class="col-md-12 mb-3">
        <h5 class="font-weight-bold text-dark mb-1">
            <i class="fa fa-file-pdf-o text-danger"></i> Career Presentation Decks
        </h5>
        <p class="text-muted" style="font-size:0.93rem;">
            Detailed technical career competency presentations prepared for LG Electronics R&amp;D recruitment.
            These decks cover research background, project experience, and technical depth in multimodal AI &amp; computer vision.
        </p>
    </div>

    <div class="col-md-12">
        <!-- Tab Navigation -->
        <ul class="nav nav-pills mb-3" id="slideTabs" role="tablist">
            <li class="nav-item">
                <a class="nav-link active" id="slide1-tab" data-toggle="pill" href="#slide1" role="tab" aria-selected="true">
                    <i class="fa fa-file-pdf-o mr-1"></i> 1차 면접 직무역량기술서
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link" id="slide2-tab" data-toggle="pill" href="#slide2" role="tab" aria-selected="false">
                    <i class="fa fa-file-pdf-o mr-1"></i> 2차 면접 직무역량기술서
                </a>
            </li>
        </ul>

        <div class="tab-content" id="slideTabContent">
            <!-- 1st Presentation -->
            <div class="tab-pane fade show active" id="slide1" role="tabpanel">
                <div class="card shadow-sm border rounded overflow-hidden">
                    <div class="card-header bg-light d-flex justify-content-between align-items-center py-2">
                        <span class="font-weight-bold text-dark" style="font-size:0.9rem;">
                            <i class="fa fa-file-pdf-o text-danger mr-2"></i>직무역량기술서 (1차 면접용)
                        </span>
                        <a href="{{ site.baseurl }}/assets/slides/lg_career_presentation_1st.pdf" target="_blank" rel="noopener noreferrer" class="btn btn-sm btn-outline-danger">
                            <i class="fa fa-external-link mr-1"></i> Open PDF
                        </a>
                    </div>
                    <div style="background:#f8f9fa; height:760px;">
                        <iframe
                            src="{{ site.baseurl }}/assets/slides/lg_career_presentation_1st.pdf"
                            width="100%"
                            height="760"
            ...
            <!-- 2nd Presentation -->
            <div class="tab-pane fade" id="slide2" role="tabpanel">
                <div class="card shadow-sm border rounded overflow-hidden">
                    <div class="card-header bg-light d-flex justify-content-between align-items-center py-2">
                        <span class="font-weight-bold text-dark" style="font-size:0.9rem;">
                            <i class="fa fa-file-pdf-o text-danger mr-2"></i>직무역량기술서 (2차 면접용)
                        </span>
                        <a href="{{ site.baseurl }}/assets/slides/lg_career_presentation_2nd.pdf" target="_blank" rel="noopener noreferrer" class="btn btn-sm btn-outline-danger">
                            <i class="fa fa-external-link mr-1"></i> Open PDF
                        </a>
                    </div>
                    <div style="background:#f8f9fa; height:760px;">
                        <iframe
                            src="{{ site.baseurl }}/assets/slides/lg_career_presentation_2nd.pdf"
                            width="100%"
                            height="760"
                            style="border:none; display:block;"
                            allowfullscreen>
